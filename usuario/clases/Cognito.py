...
class Cognito(Response):
    ...
    def create_user_cognito(self, datos):
        try:
            ...
            response = self.client.sign_up(
                ...
                Password=password,
                UserAttributes=[
                    {"Name": "custom:id_usuario", "Value": str(id_usuario)},
                ]
            )
            ...
            self.client.exceptions.UsernameExistsException,
    ...
    def admin_update_user_attributes(self,datos):
