...
class Cognito(Response):
    ...
    def get_tokens(self, datos):
        ...
        if status_code != 200:
            ...
            return self.armadoBody("Proceso exitoso.", status_code, data)
    ...
    def get_user_by_token(self, access_token):
        try:
            ...
            raise ValueError("Se encuentra sin autorización")
            ...
            raise ValueError("Error en la autenticación de usuario.")
